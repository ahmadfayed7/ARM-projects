...
unsigned char String1[10]="center";
unsigned char String2[10]="left";
unsigned char String3[10]="right";
...
void SysTick_Handler(void){
  if(GPIO_PORTA_DATA_R&0x20){   // toggle PA5
    ...
    NVIC_ST_RELOAD_R = L1-1;     // reload value for low phase
  } else{
    GPIO_PORTA_DATA_R |= 0x20;  // make PA5 high
    NVIC_ST_RELOAD_R = H1-1;     // reload value for high phase
  }
}
